...
import { pwdCrud } from '../api/modules/pwd';
import { statusLogCrud } from '../api/modules/statuslog';
...
const ApplicationProfile = () => {
  ...
  useEffect(() => {
    ...
    const loadApplication = async() => {
      const data = await pwdCrud.get(pwdId);
    ...
    const loadStatusLog = async() => {
        const data = await statusLogCrud.getAll(pwdId);
        setStatusLog(data);
        console.log(data);
    }
